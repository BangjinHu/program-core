package theory.binarytrees.util;

import java.util.ArrayDeque;

public class BuildBinarayTree {
    ...
    public static <T> void printBinaryTree(T root) {
        if (root == null) System.out.println("EMPTY!");
        // 得到树的深度
        int treeDepth = getTreeDepth((TreeNode) root);
        ...
        writeArray((TreeNode) root, 0, arrayWidth / 2, res, treeDepth);
    ...
    // 用于获得树的层数
    private static <T> int getTreeDepth(TreeNode root) {
